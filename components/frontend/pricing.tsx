      ...
      <div className="py-16 sm:py-24 md:py-32">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto mt-8 flex flex-col items-center space-y-6">
            {/* Billing toggle */}
            <div className="flex flex-col sm:flex-row items-center gap-4 bg-gray-50 p-2 rounded-full">
              <Button
          ...
          <Tabs defaultValue="predefined" className="mt-12">
            ...
            <TabsContent value="predefined" className="mt-6">
              {viewMode === "cards" ? (
                <div className="mx-auto mt-8 grid max-w-md grid-cols-1 gap-8 sm:max-w-lg md:max-w-2xl md:grid-cols-2 lg:max-w-none lg:grid-cols-3">
                  {plans.map((plan) => (
                    <div
                      key={plan.id}
                      ...
                      <div className="mt-8 flex flex-1 flex-col justify-between">
                        <ul role="list" className="space-y-3">
                          {plan.features.map((feature) => (
                            <li key={feature} className="flex gap-x-2 sm:gap-x-3 items-start sm:items-center">
                              <span className="flex-none text-[#884DEE]">{getFeatureIcon(feature)}</span>
                              <span className="text-xs sm:text-sm text-gray-600">{feature}</span>
                              <TooltipProvider>
                                <Tooltip>
                                  <TooltipTrigger asChild>
                                    <Button variant="ghost" size="icon" className="h-5 w-5 ml-auto flex-shrink-0">
                      ...
                      {addOns.map((addon) => (
                        ...
                        >
                          <div>
                            ...
                            <div className="text-xs sm:text-sm text-gray-500">{addon.description}</div>
                          </div>
          ...
          <div className="mt-12 sm:mt-16 max-w-3xl mx-auto px-4 sm:px-0">
            ...
            <Accordion type="single" collapsible className="w-full">
              ...
              <AccordionItem value="item-6">
                ...
                <AccordionContent>
                  Ano, nabízíme 14 denní bezplatnou zkušební verzi bez nutnosti zadávat platební údaje. Během zkušební
