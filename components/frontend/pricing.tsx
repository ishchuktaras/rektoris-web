    ...
    return (
        <div className="bg-white py-24 sm:py-32">
            <div className="mx-auto max-w-7xl px-6 lg:px-8">
                <div className="">
                    <SectionHeader title={"Ceny"} heading={"Transparentní ceny za výkonné nástroje"} description={"Vyberte si plán, který vyhovuje vašim obchodním potřebám. Flexibilní ceny bez skrytých poplatků, navržené tak, aby odpovídaly vašemu růstu."} />
                </div>
