...
export default function Pricing() {
  ...
  const featureDescriptions = {
    "Evidence žáků": "Kompletní správa údajů o studentech včetně osobních informací, docházky a výsledků.",
    "Základní rozvrh hodin": "Jednoduchý nástroj pro vytváření a správu rozvrhů hodin.",
    "Pokročilý rozvrh hodin": "Pokročilé funkce pro optimalizaci rozvrhů s ohledem na dostupnost učitelů a učeben.",
    "Jednoduchá klasifikace": "Základní nástroje pro hodnocení studentů a správu známek.",
    "Komplexní klasifikace": "Pokročilé nástroje pro hodnocení s možností vlastních kritérií a statistik.",
    "Základní komunikační nástroje": "Jednoduché nástroje pro komunikaci mezi učiteli, studenty a rodiči.",
    "Rozšířená komunikační platforma":
      "Pokročilá platforma s možností skupinových diskusí, sdílení souborů a oznámení.",
    "Cloudové zálohování dat": "Automatické zálohování všech dat v cloudu pro maximální bezpečnost.",
    "E-mailová podpora": "Podpora prostřednictvím e-mailu s odezvou do 24 hodin.",
    "Prioritní podpora": "Přednostní podpora s odezvou do 8 hodin v pracovní dny.",
    "Dedikovaná podpora 24/7": "Nepřetržitá podpora s vyhrazeným týmem specialistů.",
  }

  // Add-ons that can be added to any plan
  const addOns = [
    { id: "sms", name: "SMS notifikace", price: 500, description: "Automatické SMS notifikace pro rodiče a studenty" },
    { id: "api", name: "API přístup", price: 1000, description: "Přístup k API pro integraci s dalšími systémy" },
    {
      id: "reports",
    ...
    { id: "mobile", name: "Mobilní aplikace", price: 1200, description: "Přístup k systému přes mobilní aplikaci" },
  ]
      ...
      <div className="py-24 sm:py-32">
        <div className="mx-auto max-w-7xl px-6 lg:px-8">
          ...
          <Tabs defaultValue="predefined" className="mt-12">
                  ...
                  {plans.map((plan) => (
                    <div
                      ...
                      className={`flex flex-col rounded-3xl ${
                        plan.popular ? "ring-2 ring-[#884DEE]" : "ring-1 ring-gray-200"
                    ...
                    >
                      ...
                      <div className="relative">
                        ...
                        <p className="mt-2 text-base leading-7 text-gray-600">{plan.description}</p>
                        <div className="mt-6">
                          <p className="flex items-baseline gap-x-1">
                            <span className="text-4xl font-bold tracking-tight text-gray-900">
                              {isAnnual ? plan.annualPrice : plan.monthlyPrice}
                            </span>
                            <span className="text-sm font-semibold leading-6 text-gray-600">Kč</span>
                            {!isAnnual && <span className="text-sm font-semibold leading-6 text-gray-600">/měsíc</span>}
                          </p>
                        ...
                        <ul role="list" className="space-y-3">
                          {plan.features.map((feature) => (
                            <li key={feature} className="flex gap-x-3 items-center">
                              <span className="flex-none text-[#884DEE]">{getFeatureIcon(feature)}</span>
                              ...
                              <TooltipProvider>
                                <Tooltip>
                                  ...
                                  <TooltipContent>
                                    <p className="max-w-xs">{getFeatureTooltip(feature)}</p>
                                  </TooltipContent>
                                </Tooltip>
                              </TooltipProvider>
                            </li>
            ...
            <TabsContent value="custom" className="mt-6">
              <div className="mx-auto max-w-3xl bg-white rounded-3xl shadow-lg p-8 ring-1 ring-gray-200">
                <h3 className="text-2xl font-bold text-center mb-6">Vytvořte si vlastní plán</h3>
                <p className="text-center text-gray-600 mb-8">
                  Přizpůsobte si plán podle vašich specifických potřeb a získejte přesně to, co potřebujete.
                </p>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <Label htmlFor="students">Počet studentů: {customPlan.students}</Label>
                      </div>
                      <div className="flex items-center gap-2">
                        <Button variant="outline" size="icon" onClick={() => adjustCustomPlan("students", -50)}>
                          <Minus className="h-4 w-4" />
                        </Button>
                        <div className="h-2 flex-1 bg-gray-200 rounded-full relative">
                          <div
                            className="absolute h-2 bg-[#884DEE] rounded-full"
                            style={{ width: `${(customPlan.students / 2000) * 100}%` }}
                          />
                        </div>
                        <Button variant="outline" size="icon" onClick={() => adjustCustomPlan("students", 50)}>
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <Label htmlFor="teachers">Počet učitelů: {customPlan.teachers}</Label>
                      </div>
                      <div className="flex items-center gap-2">
                        <Button variant="outline" size="icon" onClick={() => adjustCustomPlan("teachers", -5)}>
                          <Minus className="h-4 w-4" />
                        </Button>
                        <div className="h-2 flex-1 bg-gray-200 rounded-full relative">
                          <div
                            className="absolute h-2 bg-[#884DEE] rounded-full"
                            style={{ width: `${(customPlan.teachers / 200) * 100}%` }}
                          />
                        </div>
                        <Button variant="outline" size="icon" onClick={() => adjustCustomPlan("teachers", 5)}>
                          <Plus className="h-4 w-4" />
                    ...
                    <div className="space-y-2">
                      <div className="flex justify-between">
                        <Label htmlFor="storage">Úložiště (GB): {customPlan.storage}</Label>
                      </div>
                      <div className="flex items-center gap-2">
                        <Button variant="outline" size="icon" onClick={() => adjustCustomPlan("storage", -5)}>
                          <Minus className="h-4 w-4" />
                        </Button>
                        <div className="h-2 flex-1 bg-gray-200 rounded-full relative">
                          <div
                            className="absolute h-2 bg-[#884DEE] rounded-full"
                            style={{ width: `${(customPlan.storage / 100) * 100}%` }}
                          />
                        </div>
                        <Button variant="outline" size="icon" onClick={() => adjustCustomPlan("storage", 5)}>
                          <Plus className="h-4 w-4" />
                    ...
                    <div className="space-y-4 mt-6">
                      ...
                      {addOns.map((addon) => (
                        <div key={addon.id} className="flex items-center justify-between p-3 border rounded-lg">
                          ...
                          <div className="flex items-center gap-4">
                            <div className="text-sm font-semibold">{addon.price} Kč/měsíc</div>
                            <Button
                              variant={selectedAddOns.includes(addon.id) ? "default" : "outline"}
                              size="sm"
                              onClick={() => toggleAddOn(addon.id)}
                            >
                              {selectedAddOns.includes(addon.id) ? "Aktivní" : "Přidat"}
                            </Button>
                          </div>
                        </div>
                      ))}
                    ...
                    <div className="space-y-4">
                      ...
                      {selectedAddOns.length > 0 && (
                        <>
                          <div className="pt-2 border-t border-gray-200">
                            <h5 className="font-medium mb-2">Vybrané doplňky:</h5>
                      ...
                      <div className="pt-4 border-t border-gray-200">
                        <div className="flex justify-between font-bold text-lg">
                          ...
                          <span>
                            {calculateCustomPrice()} Kč{isAnnual ? "/rok" : "/měsíc"}
                          </span>
                        </div>
          ...
          <div className="mt-16 max-w-3xl mx-auto">
            <h3 className="text-2xl font-bold text-center mb-8">Často kladené otázky</h3>

            <Accordion type="single" collapsible className="w-full">
              <AccordionItem value="item-1">
                <AccordionTrigger>Jak dlouho trvá implementace systému?</AccordionTrigger>
                <AccordionContent>
                  Implementace našeho systému obvykle trvá 2-4 týdny v závislosti na velikosti školy a požadovaných
                  funkcích. Náš implementační tým vám poskytne podrobný harmonogram a bude vás provázet celým procesem.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-2">
                <AccordionTrigger>Mohu změnit plán v průběhu školního roku?</AccordionTrigger>
                <AccordionContent>
                  Ano, můžete upgradovat svůj plán kdykoli během školního roku. Při upgradu vám bude účtován pouze
                  rozdíl v ceně. Downgrade na nižší plán je možný při obnovení předplatného.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-3">
                <AccordionTrigger>Jak je to s ochranou osobních údajů?</AccordionTrigger>
                <AccordionContent>
                  Náš systém je plně v souladu s GDPR a dalšími předpisy o ochraně osobních údajů. Data jsou šifrována a
                  ukládána na zabezpečených serverech v EU. Máme implementovány přísné bezpečnostní protokoly a
                  pravidelné audity.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-4">
                <AccordionTrigger>Poskytujete školení pro učitele a administrativu?</AccordionTrigger>
                <AccordionContent>
                  Ano, součástí implementace je základní školení pro administrátory a učitele. Pro pokročilé plány
                  nabízíme rozšířená školení a workshopy. K dispozici je také rozsáhlá online dokumentace a videonávody.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-5">
                <AccordionTrigger>Jaká je dostupnost technické podpory?</AccordionTrigger>
                <AccordionContent>
                  Technická podpora je k dispozici podle vašeho plánu. Základní plán zahrnuje e-mailovou podporu s
                  odezvou do 24 hodin. Standard plán nabízí prioritní podporu s odezvou do 8 hodin v pracovní dny.
                  Premium plán poskytuje dedikovanou podporu 24/7 včetně víkendů a svátků.
                </AccordionContent>
              </AccordionItem>

              <AccordionItem value="item-6">
                <AccordionTrigger>Mohu si systém nejprve vyzkoušet?</AccordionTrigger>
                <AccordionContent>
                  Ano, nabízíme 14denní bezplatnou zkušební verzi bez nutnosti zadávat platební údaje. Během zkušební
                  doby máte přístup ke všem funkcím vybraného plánu a můžete si systém důkladně otestovat ve vašem
                  prostředí.
                </AccordionContent>
              </AccordionItem>
            </Accordion>
