...
import { Search, Mail, Phone, MessageSquare, Calendar, Users, FileText, Book, School, LucideProps } from 'lucide-react';
...
const HelpPage = () => {
  ...
  const faqs: Faq[] = [
    ...
    },
    {
      ...
      answer: 'Naše rozhraní je intuitivní a snadno použitelné. Pokud narazíte na problémy, máte přístup k našemu live chat podpory, kde vám rádi pomohou. Také poskytujeme online videa, která vás provedou složitějšími procesy. Za školení nemusíte nic platit.'
    },
    {
      id: 'faq-8',
      question: 'Jak je zajištěna bezpečnost dat?',
      answer: 'Vaše školní data jsou pro nás prioritou. Každý den o půlnoci automaticky zálohujeme všechna důležitá data na oddělené fyzické úložiště. Pro přenos dat používáme stejnou SSL technologii jako internetové bankovnictví.'
    }
];
    ...
    <div className="min-h-screen bg-gradient-to-b from-blue-50 to-white">
      <div className="max-w-6xl mx-auto p-6 space-y-12">
        ...
        <section className="py-8">
          <h2 className="text-center text-2xl font-bold mb-6 text-gray-900">Užitečné články</h2>
        ...
        <section className="py-8 bg-white rounded-2xl shadow-lg p-8">
          <h2 className="text-center text-2xl font-bold mb-6 text-gray-900">Časté dotazy</h2>
          <div className="space-y-4">
            {faqs.map((faq) => (
              <Card key={faq.id} className="border-0 shadow-none">
                <CardHeader className="p-4 cursor-pointer hover:bg-blue-50 rounded-lg" onClick={() => toggleFaq(faq.id)}>
        ...
        {/* Contact Section */}
        <section className="py-8">
          <h2 className="text-2xl font-bold mb-6 text-gray-900">Kontaktujte nás</h2>
          <div className="grid md:grid-cols-3 gap-6">
            ...
            <Card className="bg-gradient-to-br from-green-50 to-white">
              ...
              <CardContent>
                ...
                <button className="mt-2 text-green-600 hover:underline">Zahájit chat</button>
              </CardContent>
            </Card>
            ...
            <Card className="bg-gradient-to-br from-purple-50 to-white">
              ...
              <CardContent>
                ...
                <p className="text-sm text-muted-foreground mt-2">Po-Pá 8:00-16:00</p>
              </CardContent>
            </Card>
          </div>
        </section>
